...
@section('title', 'UMKM Lokal - Geosite Danau Toba')
...
<style>
    ...
    .umkm-card:hover .card-image-overlay { opacity: 1; }
    .umkm-card:hover .card-image-overlay i { transform: scale(1); }
    ...
    @media (max-width: 992px) {
        .umkm-grid { grid-template-columns: repeat(2, 1fr); gap: 24px; }
        .hero-umkm h1 { font-size: 2.4rem; }
    }

    @media (max-width: 576px) {
        .umkm-grid { grid-template-columns: 1fr; gap: 20px; }
        .hero-umkm { padding: 110px 0 60px; }
        .hero-umkm h1 { font-size: 1.9rem; }
        .umkm-section { padding: 50px 0; }
...
<div class="hero-umkm">
    <div class="container">
        <div class="hero-badge">Produk Lokal</div>
        <h1>UMKM Geosite Toba</h1>
        <p>Kerajinan & Kuliner Khas Masyarakat Sekitar</p>
    ...
    <div class="container">
        <div class="umkm-grid">
            @forelse($data as $item)
                ...
                @endphp
                <a href="{{ route('umkm.detail', $item->id) }}" class="umkm-card">
                    <div class="card-image-wrapper">
                        <img src="{{ $imgSrc }}" alt="{{ $item->nama_usaha }}" loading="lazy"
