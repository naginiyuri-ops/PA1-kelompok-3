...
<style>
    ...
    .card-badge {
        position: absolute; top: 15px; left: 15px; background: white; color: var(--primary-dark);
        padding: 5px 14px; border-radius: 30px; font-size: 0.68rem; font-weight: 700;
    ...
    .card-excerpt {
        font-size: 0.87rem; color: var(--text-gray); line-height: 1.65; margin-bottom: 18px;
