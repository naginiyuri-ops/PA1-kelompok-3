{{-- Halaman Destinasi Budaya — konten dirender langsung oleh PublicDestinationController::budaya() --}}
@extends('layouts.app')
...
<style>
    ...
    .dest-grid{display:grid;grid-template-columns:repeat(3,minmax(260px,1fr));gap:35px;}
        ...
        <div class="dest-grid">
            ...
            <a href="{{ route('destinasi.detail', [$category, $item->id]) }}" class="dest-card">
                <div class="card-img-wrapper">
                    <img src="{{ $item->image_url }}" alt="{{ $item->title_trans }}" loading="lazy" onerror="this.onerror=null; this.src='{{ asset('image/default.jpg') }}'">
