...
{{-- FASILITAS AKOMODASI (DARI TABLE FASILITAS) --}}
@if(isset($fasilitasAkomodasi) && $fasilitasAkomodasi->count())
<section class="penginapan-section" style="padding-top:30px;">
    <div class="container">
        <h3 style="margin-bottom:20px;">Fasilitas Akomodasi</h3>
        <div class="dest-grid">
            @foreach($fasilitasAkomodasi as $item)
