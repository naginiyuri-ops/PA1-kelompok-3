...
<div class="card-table">
    <div class="card-header">
        ...
        <a href="{{ route('admin.informasi.create') }}" class="btn-primary">
    ...
    <div class="stats-bar">
        <span class="stats-badge">
            <i class="fas fa-database"></i> Total: {{ $informasi->total() }}
        </span>
        <span class="stats-badge">
            <i class="fas fa-eye"></i> Halaman {{ $informasi->currentPage() }} / {{ $informasi->lastPage() }}
        </span>
    </div>
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td data-label="No">{{ $key + $informasi->firstItem() }}</td>
                    ...
                    <td data-label="Aksi">
                        <div class="btn-group">
                            ...
                            <form action="{{ route('admin.informasi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus informasi ini?')" style="display: inline;">
                                @csrf
                                @method('DELETE')
                ...
                <tr>
                    <td colspan="5" class="empty-state">
                        ...
                        📭 Belum ada informasi
                        <p style="margin-top: 10px; font-size: 0.8rem;">Klik tombol "Tambah Informasi" untuk mulai menambahkan</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
