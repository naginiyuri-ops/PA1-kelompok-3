    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.agenda.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="agenda_judul_id" name="judul" class="form-control" value="{{ old('judul') }}" required>
            </div>
            
            <div class="mb-3">
                <label>Deskripsi <span class="text-danger">*</span></label>
                <textarea id="agenda_deskripsi_id" name="deskripsi" class="form-control" rows="10" required>{{ old('deskripsi') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="penyelenggara" class="form-control" value="{{ old('penyelenggara', 'Admin') }}">
                    </div>
                </div>
            </div>
