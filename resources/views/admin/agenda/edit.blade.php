    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="agenda_judul_id" name="judul" class="form-control" value="{{ old('judul', $agenda->judul) }}" required>
            </div>
            
            <div class="mb-3">
                <label>Deskripsi <span class="text-danger">*</span></label>
                <textarea id="agenda_deskripsi_id" name="deskripsi" class="form-control" rows="10" required>{{ old('deskripsi', $agenda->deskripsi) }}</textarea>
...
<div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        @if($agenda->gambar)
                            @php
                                ...
                                if (file_exists(public_path($agenda->gambar))) {
                                    $imgUrl = asset($agenda->gambar);
                                } elseif (file_exists(public_path('image/agenda/' . $agenda->gambar))) {
                                    $imgUrl = asset('image/agenda/' . $agenda->gambar);
                                }
                            @endphp
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_mulai" class="form-control" value="{{ old('tanggal_mulai', $agenda->tanggal_mulai) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="checkbox" name="status" value="1" id="status" {{ old('status', $agenda->status) ? 'checked' : '' }}>
