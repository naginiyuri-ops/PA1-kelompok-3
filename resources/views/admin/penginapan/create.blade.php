...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.penginapan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label>Nama Penginapan <span style="color:#e74c3c;">*</span></label>
                <input type="text" name="nama" id="penginapan_nama" class="form-control"
                       value="{{ old('nama') }}" placeholder="Contoh: Homestay Danau Indah" required>
            </div>

            <div class="mb-3">
                <label>Deskripsi <span style="color:#e74c3c;">*</span></label>
                <textarea name="deskripsi" id="penginapan_deskripsi" class="form-control"
                          rows="5" placeholder="Deskripsikan penginapan ini..." required>{{ old('deskripsi') }}</textarea>
            </div>
                    ...
                    <div class="mb-3">
                        <label>Lokasi</label>
                           <input type="text" name="lokasi" class="form-control"
                               value="{{ old('lokasi') }}" placeholder="Contoh: Desa Taman Eden, Kec. Tampahan">
                    </div>
                </div>
                <div class="col-half">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-half">
                    <div class="mb-3">
                        ...
                        <div class="form-text"><i class="fas fa-info-circle"></i> Nomor HP / WhatsApp pemilik penginapan.</div>
                    </div>
                </div>
                <div class="col-half">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-half">
                    <div class="mb-3">
                        ...
                        <img id="previewGambar" class="preview-image" alt="Preview Gambar">
                    </div>
                </div>
                <div class="col-half">
                    <div class="mb-3">
                        ...
                        <img id="previewGambarTambahan" class="preview-image" alt="Preview Gambar Tambahan">
                    </div>
                </div>
            </div>
            ...
            <div class="checkbox-group">
                <input type="checkbox" name="status" value="1" id="status_penginapan" {{ old('status', 1) ? 'checked' : '' }}>
                <label for="status_penginapan"><i class="fas fa-toggle-on"></i> Aktifkan Penginapan (tampil di halaman pengunjung)</label>
            </div>
