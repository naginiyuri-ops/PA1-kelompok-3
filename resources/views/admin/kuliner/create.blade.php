    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.Kuliner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama" id="Kuliner_nama" class="form-control"
                       value="{{ old('nama') }}" placeholder="Contoh: Homestay Danau Indah" required>
            </div>

            <div class="mb-3">
                <label>Deskripsi <span style="color:#e74c3c;">*</span></label>
                <textarea name="deskripsi" id="Kuliner_deskripsi" class="form-control"
                          rows="5" placeholder="Deskripsikan Kuliner ini..." required>{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="row">
                <div class="col-half">
                    <div class="mb-3">
                        ...
                        <div class="form-text"><i class="fas fa-info-circle"></i> Nomor HP / WhatsApp pemilik Kuliner.</div>
                    </div>
                </div>
                <div class="col-half">
                    <div class="mb-3">
            ...
            <div class="checkbox-group">
                <input type="checkbox" name="status" value="1" id="status_Kuliner" {{ old('status', 1) ? 'checked' : '' }}>
