    ...
    <div style="padding:28px;">
        ...
        <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom:22px;">
                ...
                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Contoh: Pemandangan Danau Toba di Pagi Hari..."
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                ...
                <div style="margin-bottom:22px;">
                    ...
                    <select name="kategori"
                        ...
                        <option value="taman-eden" {{ old('kategori') == 'taman-eden' ? 'selected' : '' }}>Taman Eden</option>
                ...
                <div style="margin-bottom:22px;">
                    ...
                    <input type="text" name="lokasi" value="{{ old('lokasi') }}" placeholder="Contoh: Pulau Samosir, Danau Toba"
                           style="width:100%; padding:10px 14px; border:1.5px solid #e2e8f0; border-radius:10px; font-size:0.9rem; outline:none; transition:border-color 0.2s;"
            ...
            <div style="margin-bottom:22px;">
                ...
                <textarea name="deskripsi" placeholder="Jelaskan tentang foto ini..." rows="4"
                          ...
                          onfocus="this.style.borderColor='#003366'" onblur="this.style.borderColor='#e2e8f0'" required>{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                ...
                <div style="margin-bottom:22px;">
                    <label style="display:block; margin-bottom:8px; font-weight:600; font-size:0.85rem; color:#1e293b;">
                        Gambar <span style="color:#dc2626;">*</span>
                    </label>
                ...
                <div style="margin-bottom:22px;">
                    ...
                    <input type="date" name="tanggal_foto" value="{{ old('tanggal_foto') }}"
                           style="width:100%; padding:10px 14px; border:1.5px solid #e2e8f0; border-radius:10px; font-size:0.9rem; outline:none; transition:border-color 0.2s;"
                           onfocus="this.style.borderColor='#003366'" onblur="this.style.borderColor='#e2e8f0'">
                </div>
            </div>
            ...
            <div style="display:flex; align-items:center; gap:10px; margin:0 0 22px 0; padding:14px 18px; background:#fff7ed; border-radius:12px; border:1px solid #f5d0a9;">
                <input type="checkbox" name="is_unggulan" value="1" id="is_unggulan" {{ old('is_unggulan') ? 'checked' : '' }}
