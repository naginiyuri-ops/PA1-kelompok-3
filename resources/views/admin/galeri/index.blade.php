    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td data-label="No">{{ $key + $galeri->firstItem() }}</td>
                    ...
                    <td data-label="Aksi">
                        <div class="btn-group">
                            <a href="{{ route('admin.galeri.edit', $item->id) }}" class="btn-edit">
                ...
                <tr>
                    <td colspan="7" class="empty-state">
                        ...
                        <p style="margin-top: 10px; font-size: 0.8rem;">Klik tombol "Tambah Galeri" untuk mulai menambahkan</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
