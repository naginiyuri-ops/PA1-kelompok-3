...
class DestinasiController extends Controller
{
    ...
    {
        // Data lengkap untuk detail - dengan FIELD FOTO masing-masing
        $dataDestinasi = [
            'alam' => [
                'items' => [
                    'desa-wisata-meat' => [
            ...
            'budaya' => [
                'items' => [
                    'sentra-tenun-ulos' => [
                        ...
                        'deskripsi_lengkap' => 'Ulos adalah kain tenun tradisional khas masyarakat Batak yang memiliki nilai budaya dan makna adat yang sangat penting. Ulos dibuat secara manual menggunakan alat tenun tradisional dengan berbagai motif dan warna khas Batak.
                          Bagi masyarakat Batak, ulos bukan hanya kain, tetapi juga simbol kasih sayang, doa, penghormatan, dan berkat yang biasa digunakan dalam upacara adat, pernikahan, kelahiran, hingga acara penting lainnya.',
                        'jam_operasional' => '08:00 - 17:00 WIB',
                    ...
                    'rumah-adat-batak' => [
                        ...
                        'deskripsi_lengkap' => 'Rumah Adat Batak merupakan rumah tradisional masyarakat Batak Toba yang menjadi simbol budaya dan warisan leluhur. Rumah ini memiliki bentuk khas dengan atap melengkung menyerupai punggung kerbau serta dihiasi ukiran gorga berwarna merah, hitam, dan putih. Rumah adat Batak dibangun menggunakan kayu dan berbentuk rumah panggung. Selain berfungsi sebagai tempat tinggal, rumah ini juga menjadi simbol kebersamaan, adat, dan kehidupan masyarakat Batak yang masih menjunjung tinggi nilai kekeluargaan.',
            ...
            'buatan' => [
                'items' => [
                    'spot-pantai-meat' => [
                        ...
                        'deskripsi_lengkap' => 'Spot Pantai Meat merupakan area wisata di tepian Danau Toba yang dilengkapi dengan gazebo sebagai tempat bersantai sambil menikmati pemandangan danau dan perbukitan hijau. Suasana yang tenang serta udara yang sejuk membuat tempat ini cocok digunakan untuk beristirahat, berkumpul bersama keluarga, dan menikmati panorama alam Desa Meat.',
                        'jam_operasional' => '06:00 - 18:00 WIB',
