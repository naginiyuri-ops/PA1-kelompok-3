...
class AdminWisataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
            ...
            'nama_wisata_en' => \App\Helpers\TranslateHelper::translateToEnglish($request->nama_wisata),
            'tipe_wisata' => $request->tipe_wisata,
            'deskripsi' => $request->deskripsi,
            'deskripsi_en' => \App\Helpers\TranslateHelper::translateToEnglish($request->deskripsi),
            'sejarah' => $request->sejarah,
            'sejarah_en' => \App\Helpers\TranslateHelper::translateToEnglish($request->sejarah),
            'keunikan' => $request->keunikan,
            'keunikan_en' => \App\Helpers\TranslateHelper::translateToEnglish($request->keunikan),
